!function() {
    ...
    class TrackVerticalView {
        ...
        constructor(canvas, imagesModel, cellsModel, chipsNavigationModel, stateModel) {
            ...
            this._endX = 0;
            this._endY = 0;
            this._size = TrackVerticalView.SMALL_SIZE;
            this._enable = false;
        ...
        _initCells() {
            ...
            for (let i = 0; i < ids.length; i++) {
                ...
                let cell = new CellView(this._canvas, this._imagesModel, cellModel, cellModel.vertical, this._chipsNavigationModel, this._stateModel, 'track', 'vertical');
        ...
        _drawTrack() {
            if (!this._canvas.mobile) return;
            let image = this._imagesModel.getImage('img/roulette/track/vertical/track.svg');
            this._scale = this._size / image.width;
            let imageWidth = this._size;
            let imageHeight = image.height * this._scale;
            this._x = this._canvas.canvas.width - TrackVerticalView.SHIFT - imageWidth;
        ...
        _outCell() {
            ...
            this._over = false;
            $(this).trigger(TrackVerticalView.OUT_EVENT);
        }
        ...
        _onCellOver(event) {
            this._over = true;
            $(this).trigger(TrackVerticalView.OVER_EVENT, event.target);
        }
        ...
        mouseClick(parentX, parentY) {
            ...
            if (this._enable) {
                ...
                let y = (parentY - this._y) / this._scale;
                let cell = this._getCellUnderCursor(x, y);
                if (cell) $(this).trigger(TrackVerticalView.BET_EVENT, cell);
            }
            else {
                $(this).trigger(TrackVerticalView.CLICK_EVENT);
            }
        }
        ...
        enable() {
            ...
            this._animation = new TWEEN.Tween(this)
                .to({_size: TrackVerticalView.BIG_SIZE}, TrackVerticalView.ANIMATION_DURATION)
                .start();
        }
        ...
        disable() {
            ...
            this._animation = this._animation = new TWEEN.Tween(this)
                .to({_size: TrackVerticalView.SMALL_SIZE}, TrackVerticalView.ANIMATION_DURATION)
                .start();
        }
    ...
    window.classes.TrackVerticalView = TrackVerticalView;
}();